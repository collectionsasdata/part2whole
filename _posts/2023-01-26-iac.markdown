...
**Collections as Data: Part to Whole** and the pre-cursor effort **Always Already Computational: Collections as Data** are committed to including as many perspectives as possible in the development of collections as data community. Accordingly, we aim to foster multiple paths to participation in Collections as Data: State of the Field and Future Directions.  
...
- Emily Maemura, University of Illinoisa at Urbana Champaign
...
Following the in-person event, from May to June 2023, we will release a draft version of the **Collections as Data: State of the Field and Future Directions** white paper and an updated version of the [Santa Barbara Statement on Collections as Data](https://collectionsasdata.github.io/statement/) for contributions from the broader community. 

## Incorporation and Sharing

In July the project team will incorporate all community inputs and openly release the final outputs in August 2023. 
